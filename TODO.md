...
* [ ] Correctly handle half-closed TCP streams where possible.
...
* [ ] Ensure one failed request cannot terminate the server.
* [ ] Add basic counters for requests and errors.
...
* [ ] Add multi-domain localhost tests.
